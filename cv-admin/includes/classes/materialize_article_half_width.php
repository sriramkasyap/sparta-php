<?php
	class materialize_article_half_width extends post {
		public static $snippet_meta = array('banner_image' => ['image', 'img/slide1.jpg'],
											'image_alternate_text' => ['varchar','Alternate Text'],
											'post_title' => ['varchar','Lorem Ipsum'],
		...
		function create_structure(){
			...
			$html_structure .= '<div id="article" class="grey lighten-5 "><!--Begin Article-->
							        <div class="container">
										<img src="' . $meta['banner_image'][1] . '" class="col s6 responsive-img right" alt="' . $meta['image_alternate_text'][1] . '"/><!--Side Image of Height:300px, Width: 600px-->
