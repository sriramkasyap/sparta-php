<?php
	class materialize_article_full_width extends post {
								...
								<div class="col s9 m6 right">
									<div class="underline right blue"></div>
										<h3 class="cove-text right">' . $meta['post_title'][1] . '</h3>
												...
												<img src="' . $meta['banner_image'][1] . '" class="col s4 responsive-img jumbotron card z-depth-2" alt="' . $meta['image_alternate_text'][1] . '"/>';
